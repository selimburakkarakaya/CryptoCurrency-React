...
const CoinDetailPage = () => {
    ...
    return (
        <div>
            {coin.market_data ? (
                <div className='max-w-[768px] mx-auto mt-16'>
                    <div className='bg-primary py-6 shadow-lg rounded-lg'>
                        <h1 className='text-center text-white font-semibold text-3xl'>{coin.name}</h1>
                    </div>
                    <div className='bg-primary py-6 shadow-lg rounded-lg mt-12 px-4'>
                        <div>
                            <span className='text-[#4b4b4b] bg-[#83c70a] rounded-sm border-4 border-[#f9e871] py-1 px-2'>Rank # {coin.market_cap_rank}</span>
                        </div>
                        <div className='flex items-center justify-between mt-4'>
                            <div className='flex items-center justify-center gap-x-4 text-white'>
                                {
                                    coin.image ? (
                                        <img src={coin.image.small} alt="coin-img-sm" />
                                    ) : null
                                }
                                <p className='text-lg'>{coin.name}</p>
                                {
                                    coin.symbol ? (
                                        <p className='text-sm text-[#83c70a]'>{coin.symbol.toUpperCase()}</p>
                                    ) : null
                                }
                            </div>
                            <div>
                    ...
                    <div className='bg-primary shadow-lg rounded-lg mt-12 py-5 px-4 text-white'>
                        <div className='flex lg:flex-row flex-col justify-between lg:gap-x-12 lg:gap-y-0 gap-y-4'>
                            <div className='flex lg:flex-row flex-col justify-between lg:w-1/2 w-full lg:gap-y-0 gap-y-4'>
                                <div className='flex lg:flex-col justify-between lg:gap-x-0 gap-x-2 lg:pb-0 pb-2 lg:border-none border-b'>
                                    <h4 className='font-semibold'>24 Hour Low</h4>
                                    <p>${coin.market_data.low_24h.usd}</p>
                                </div>
                                <div className='flex lg:flex-col justify-between lg:gap-x-0 gap-x-2 lg:pb-0 pb-2 lg:border-none border-b lg:mt-0 mt-8'>
                            ...
                            <div className='flex lg:flex-row flex-col justify-between lg:w-1/2 w-full lg:gap-y-0 gap-y-4'>
                                ...
                                <div className='flex lg:flex-col justify-between lg:gap-x-0 gap-x-2 lg:pb-0 pb-2 lg:mt-0 mt-8'>
